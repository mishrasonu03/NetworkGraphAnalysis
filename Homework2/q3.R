...
plot(pb_g_n_a, xlab = "node", ylab = "probability")
...
plot(pb_g_n_b, xlab = "node", ylab = "probability")
plot(deg_g_b,pb_g_n_b, xlab = "degree", ylab = "Rank scores")
...
plot(pb_g_n_c, xlab = "node", ylab = "probability")
plot(deg_g_c,pb_g_n_c, xlab = "degree", ylab = "Rank scores")