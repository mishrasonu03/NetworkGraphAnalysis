...
for (i in 1:length(core_node))
{
  ...
  for (j in 1:length(community_core))
  {
    ...
    if (length(community_vertex > 10))
    {
      ...
      clus = c(clus, transitivity(tmp_g,type = "globalundirected"))
    }
  }
...
plot(core_node, max_den, xlab = "Node Index", ylab = "Density")
plot(core_node, max_clus, xlab = "Node Index", ylab = "Cluster Coefficient")
plot(core_node, max_den_clus, xlab = "Node Index", ylab = "Density * Cluster Coefficient")
plot(core_node, min_den, xlab = "Node Index", ylab = "Density")
plot(core_node, min_clus, xlab = "Node Index", ylab = "Cluster Coefficient")
plot(core_node, min_den_clus, xlab = "Node Index", ylab = "Density * Cluster Coefficient")
